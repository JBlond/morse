...
class Morse
{
    ...
    public array $letters = [
        ...
        'Ș' => '1111', 'Š' => '1111', 'Ŝ' => '00010', 'ß' => '0001100', 'Þ' => '01100', 'Ü' => '0011',
        ...
        // mose of them are already in the Arabic Alphabet, so here are only the additions
    ...
    public function getCharacter(string $input): string
    {
        ...
        if(! isset($this->letters[strtoupper($input)])){
            return '#';
        }
        return $this->letters[strtoupper($input)] . ' ';
    }
